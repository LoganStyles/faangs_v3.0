                    ...
                    <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
                        ...
                        $navs=$active="";
                         if (isset($_SESSION['username']) && ($_SESSION['status'] == 2)) {
                             ...
                             $navs.="<a class=\"nav-link link text-primary display-4 $active \" href=\"chat.php\">Forum</a></li>";
                             $navs.=$friend_req;
                             $navs.="<li class=\"nav-item\">";
                             if($page=="contest"){$active='active';}else{$active='';}
                             $navs.="<a class=\"nav-link link text-primary display-4 $active\" href=\"contest.php?category=general\">Contestants</a></li>";
                             ...
                             $navs.="<li class=\"nav-item\"><a class=\"nav-link link text-primary display-4 $active\" href=\"participate.php\">Profile</a></li>";
                             $navs.="<li class=\"nav-item\"><a class=\"nav-link link text-primary display-4\" href=\"incl/outs.php\">Sign Out</a></li>";
                         } else if (isset($_SESSION['admin'])) {
                             if($page=="adminpage"){$active='active';}else{$active='';}
                             $navs.="<li class=\"nav-item\"><a class=\"nav-link link text-primary display-4 $active\" href=\"adminpage.php\">Dashboard</a></li>";
                             $navs.="<li class=\"nav-item\"><a class=\"nav-link link text-primary display-4\" href=\"incl/outs.php\">Sign Out</a></li>";
